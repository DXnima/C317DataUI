<template>
  <previewWrapper :pageId="pageId" @closePreview="closePreview">
    <p class="page-title paddingL30" style="color: white">页面基础设置</p>
    <div class="preview-info-wrapper">
      <div class="page-info">
        ...
        <div class="page-title-des">
          <div class="info-form-wrapper">
            <div class="info-form-l" style="color: white">标题：</div>
            <div class="info-form-r">
              <el-input v-model="pageData.title"/>
            </div>
          </div>
          <div class="info-form-wrapper">
            <div class="info-form-l" style="color: white">描述：</div>
            <div class="info-form-r">
      ...
      <div class="info-form-wrapper">
        <div class="info-form-l">
          <el-checkbox v-model="pageData.shareConfig.shareWx" style="color: white">设置微信分享样式</el-checkbox>
        </div>
      </div>
      <div v-show="pageData.shareConfig.shareWx" class="share-wx-config-wrapper marginB30">
        <div class="info-form-r page-info">
          ...
          <div class="page-title-des">
            <div class="info-form-wrapper">
              <div class="info-form-l" style="color: white">分享标题：</div>
              <div class="info-form-r">
                <el-input v-model="pageData.shareConfig.title"/>
              </div>
            </div>
            <div class="info-form-wrapper">
              <div class="info-form-l" style="color: white">分享描述：</div>
              <div class="info-form-r">
      ...
      <!--翻页方式-->
      <div class="info-form-wrapper">
        <div class="info-form-l com-width" style="color: white">翻页方式：</div>
        <div class="info-form-r">
      ...
      <div class="info-form-wrapper">
        ...
        <div class="info-form-r">
          <el-checkbox v-model="pageData.slideNumber" style="color: white">显示页码</el-checkbox>
        </div>
      </div>
      <!--作品访问状态-->
      <div class="info-form-wrapper">
        <div class="info-form-l com-width" style="color: white">作品访问状态：</div>
        <div class="info-form-r">
...
<script>
	...
	import imageCropper from '@/components/image-manage/image-cropper'
