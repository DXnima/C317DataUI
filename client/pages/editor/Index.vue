<template>
  <div class="page-editor editor-wrapper" v-loading="loading">
      ...
      <el-tabs tab-position="left" v-model="activeSideBar" style="height: 100%;">
        <el-tab-pane v-for="(item, index) in sidebarMenus" :key="index" :name="item.value">
          <el-tooltip slot="label" class="item" effect="dark" :content="item.label" placement="right">
            <i :class="item.elementUiIcon" style="color:#fff;"></i>
          </el-tooltip>
        </el-tab-pane>
      </el-tabs>
    </div>
    ...
    <!--属性编辑区域-->
    <div class="el-attr-edit-wrapper scrollbar-wrapper"  style="color: white">
...
<script>
	...
	import imageLibs from '@/components/image-manage/image-libs'
...
<style lang="scss" scoped>
  .editor-wrapper {
    ...
    height: 100%;
    color: white;
    border-top:15px solid #2a4a79;
    border-bottom: 15px solid #2a4a79;
    border-right: 15px solid #2a4a79;
    border-left: 15px solid #2a4a79;
